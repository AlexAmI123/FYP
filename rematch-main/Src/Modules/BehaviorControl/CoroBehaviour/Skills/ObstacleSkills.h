...
namespace CoroBehaviour
{
  ...
  struct ObstacleSkills
  {
    ...
    // bool isOpponentCloseToTeammate(int playerNumberOfInterest, float distance)
    // {
    //   for (const Teammate& teammate : theTeamData.teammates)
    //   {
    //     if (teammate.number == playerNumberOfInterest)
    //     {
    //       for (const Obstacle& obstacle : teammate.theObstacleModel.obstacles)
    //       {
    //         if ((obstacle.type == Obstacle::opponent) && (obstacle.center.norm() < distance))
    //           return true;
    //       }
    //     }
    //   }
    //   return false; // no opponent closer than distance to specified teammate
    // }
    ...
    // bool nearestOpponentDistance(int playerNumber)
    // {
    ...
    //           if (isCloserThan(obstacle.center-theRobotPose.translation, 2000.0f))
    //             return true;
    //           else 
    //             return false;
    //         }
