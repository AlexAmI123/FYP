...
#include "Modules/BehaviorControl/CoroBehaviour/Control/RC2022DynamicBallHandling/InterceptSkills.h"
#include "Modules/BehaviorControl/CoroBehaviour/Control/RC2022DynamicBallHandling/BallAndKickSkills.h"
#include "Modules/BehaviorControl/CoroBehaviour/Skills/ObstacleSkills.h"
// #include "Modules/BehaviorControl/CoroBehaviour/Control/RE2019Game/GotoBallSkills.h"
...
namespace RC2022
{
  // struct Poses
  // {
  //   Pose2f startingPoseLeft;
  //   Poses(BehaviourEnv& env) : env(env) {}
  ...
  */
  ...
  CRBEHAVIOUR(AttackingBallPlayerPlayingTask)
  {
    ...
    void operator()(int prevPassKicker, int prevPassReceiver)
    {
      ...
      CRBEHAVIOUR_LOOP()
      {
        ...
        while (!theFieldDimensions.isInsideOpponentGoal(theFieldBall.endPositionOnField))
        {
  ...
  private:
    ...
    // RE2019::GotoBallAndKickBestOptionTask gotoBallAndKickBestOptionTask {env};
