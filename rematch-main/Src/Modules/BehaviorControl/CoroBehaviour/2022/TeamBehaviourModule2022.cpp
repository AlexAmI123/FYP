/**
 * @file TeamBehaviourModule2022.cpp
 *
...
#include "TeamBehaviourModule2022.h"
...
#include "Modules/BehaviorControl/CoroBehaviour/Control/RC2022DynamicBallHandling/DynamicBallHandlingTeamCoordination.h"


DECL_TLOGGER(tlogger, "TeamBehaviourModule2022", TextLogging::INFO);

MAKE_MODULE(TeamBehaviourModule2022, behaviorControl, TeamBehaviourModule2022::getExtModuleInfo);

TeamBehaviourModule2022::TeamBehaviourModule2022()
...
std::vector<ModuleBase::Info> TeamBehaviourModule2022::getExtModuleInfo()
{
  auto result = TeamBehaviourModule2022::getModuleInfo();
...
void TeamBehaviourModule2022::update(TeamActivationGraph& teamActivationGraph)
{
  ...
  teamActivationGraph.graph.emplace_back("TeamBehaviourModule2022", 0, "", theFrameInfo.time, 0, std::vector<std::string>());
...
CoroBehaviour::BehaviourEnv::RepresentationRegistry TeamBehaviourModule2022::initRegisteredRepresentations()
{
  CoroBehaviour::BehaviourEnv::RepresentationRegistry representationRegistry;

#define TEAM_REPRESENTATIONS_FOR_BEHAVIOUR
#include "TeamBehaviourRepresentations2022.inc"
...
void TeamBehaviourModule2022::registerEntryPointBehaviours()
{
  using namespace CoroBehaviour;

  REGISTER_TEAM_CORO(NoTeamCoordinationTask);
  REGISTER_TEAM_CORO(MinimalTeamCoordinationTask);
  REGISTER_TEAM_CORO(RC2022::DynamicBallHandlingTeamCoordinationTask);
